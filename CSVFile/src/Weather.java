...
public class Weather {
    ...
    void testColdestHourFile(){
        ...
        System.out.println("Coldest Temperature in file  is "+coldest.get("TemperatureF")+" at "+coldest.get("DateUTC"));
    }
    /*
     ...
     */
   public String fileWithColdestTemperatue(){
    ...
    public void testFileWithColdestTemperature(){
        ...
        System.out.println("Coldest temperature day of all files was in the file "+coldestFile);
        ...
        System.out.println("Coldest Temperature on that particular day was "+coldestRecord.get("TemperatureF"));
        System.out.println("All the Temperatures recorded on the coldest day were ");
    ...
    double averageTemperatureInFile(CSVParser parser){
        ...
        return (double)total/totalRecords;
    ...
    void testAverageTemperatureWithHighHumidityInFile(){
        ...
        double averageTemp=averageTemperatureWithHighHumidityInFile(parser,70);
        ...
        if(averageTemp==0.0){
            ...
            System.out.println("Average Temperature with High High Humidity in File is "+averageTemp);



    }
    public void testingWeather(){
        testColdestHourFile();
        testFileWithColdestTemperature();
        testLowestHumidityFile();
